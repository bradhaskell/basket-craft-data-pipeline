...
#%%
# Load MYSQL and Postgres connection details
...
#%%
# Build connection strings and create database engines
...
# %%
print(f'{len(df)} records loaded into Postgres raw.website_sessions table.')